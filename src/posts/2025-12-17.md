...
I've found time between work/research for fun too! Visited KindleFest in Kerrytown/Main St. and the Tiny Expo in the downtown Ann Arbor District Library branch (I never realized how active this town gets around the holidays!). I've also kept up with Pokémon Go (and the <i>Pokémon Legends: Z-A</i> DLC!) and this year's Detroit Lions season (I miss when half our roster wasn't injured). Life keeps happening no matter how much I try and set it aside for work; perhaps there's a lesson to learn from this (ᵕ,—ᴗ—,)
