...
Regarding my website: my goal is for the mayworms.info overhaul to go live by the end of September (a little over a week from now!). I enjoyed using this Jekyll template for a while, but chose to rewrite my website in <a href="https://www.11ty.dev" target="_blank"><b>11ty</b></a> and to redesign the CSS on my own rather than using a template (being stuck with someone else’s design choices is no fun!). Here’s hoping that the website overhaul turns out well 🙏